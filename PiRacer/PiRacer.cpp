...
float PiRacer::getBatteryVoltage()
{
	return _batteryMonitor.getBusVoltage() + _batteryMonitor.getShuntVoltage();
}

float PiRacer::getBatteryCurrent()
{
	return _batteryMonitor.getCurrent();
}

float PiRacer::getPowerConsumption()
{
